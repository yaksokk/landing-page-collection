...
const typewriterRoles = {
  id: ['UI/UX Designer', 'Frontend Developer', 'Problem Solver', 'Creative Thinker'],
  en: ['UI/UX Designer', 'Frontend Developer', 'Problem Solver', 'Creative Thinker']
};
...
function startTypewriter() {
  ...
  function type() {
    const roles = typewriterRoles[currentLang];
